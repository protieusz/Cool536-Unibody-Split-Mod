...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LSFT_T(KC_Z), KC_X, C_C,    KC_V,    KC_B,               KC_N,               KC_M,     KC_COMM,  KC_DOT,  RSFT_T(KC_SLSH), 
  ...
  [_LOWER] = LAYOUT(
    ...
    _______,  _______,   KC_MUTE,   KC_VOLU,   KC_VOLD,             KC_GRV,              KC_JYEN,  RSFT(KC_LBRC), RSFT(KC_RBRC),  KC_BSLS,
